...
function DecorVendorsManager() {
    ...
    const fetchVendors = async () => {
        try {
            const res = await axios.get('/decor-vendors');
            setVendors(res.data);
        } catch (err) {
            console.error(err);
        }
    ...
    const handleDelete = async (vendorId) => {
        ...
        try {
            await axios.delete(`/delete-decor-vendor/${vendorId}`);
            fetchVendors();
        } catch (err) {
            console.error(err);
        }
    ...
    const handleAddVendor = async () => {
        try {
            await axios.post('/add-decor-vendor', newVendor);
            setNewVendor({
                name: '',
                contact_no: '',
                city: '',
...
export default DecorVendorsManager;
